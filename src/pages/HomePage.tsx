            ...
            >
              <Container>
                ...
                <Menu.Item position='right'>
                  ...
                  <Button as='a' inverted={!fixed} primary={fixed} style={{ marginLeft: '0.5em' }}>Sign
                    Up</Button>
                </Menu.Item>
              </Container>
            </Menu>
    ...
    return (
      <Responsive {...Responsive.onlyMobile}>
        <Sidebar.Pushable>
          ...
          <Sidebar.Pusher dimmed={sidebarOpened} onClick={this.handleToggle}
                          style={{ minHeight: '100vh' }}>
            <Segment inverted textAlign='center' style={{ minHeight: 350, padding: '1em 0em' }}
                     vertical>
              <Container>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        ...
        <p style={{ fontSize: '1.33em' }}>
          ...
          it's really
          true.
          It took years of gene splicing and combinatory DNA research, but our bananas can really
          dance.
        </p>
